document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navbarEl = document.querySelector('nav, .navbar, [data-navbar]');
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          return (field.dataset.errorMaxlength || 'Maximum {max} characters allowed.').replace('{max}', max);
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Dispatch custom event so integrations can hook in
      const submitEvent = new CustomEvent('contactFormValid', {
        bubbles: true,
        detail: { form: contactForm }
      });
      contactForm.dispatchEvent(submitEvent);

      // Default success feedback if not prevented by custom handler
      ...
      if (submitBtn) {
        ...
        // Re-enable after 4 s as a safety fallback
        setTimeout(function () {
  ...
  const animatableEls = document.querySelectorAll(OBSERVED_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'acd54c59-7dee-49af-9413-232249b9093a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'acd54c59-7dee-49af-9413-232249b9093a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'acd54c59-7dee-49af-9413-232249b9093a';
